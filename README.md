...
- Solution URL: [Solution URL](https://github.com/nishanth1596/news-homepage)
- Live Site URL: [Live site URL](https://nishanth-news-homepage.netlify.app/)
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/nishanth1596/news-homepage.git
   ```
...
Google Fonts - I used the Inter fonts from Google Fonts to style the text.
